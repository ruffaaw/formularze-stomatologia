...
class StatementWithVarnishAndDentistScreen extends StatefulWidget {
  const StatementWithVarnishAndDentistScreen({super.key});

  @override
  State<StatementWithVarnishAndDentistScreen> createState() =>
      _StatementWithVarnishAndDentistScreenState();
}

class _StatementWithVarnishAndDentistScreenState
    extends State<StatementWithVarnishAndDentistScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Oświadczenie z lakierowaniem i stomatologiem'),
      ),
  ...
  Future<void> generateAndSavePDF(BuildContext context) async {
    ...
    try {
      ...
      final fileName =
          '${name}_${DateFormat('ddMMyyyy_HHmmss').format(DateTime.now())}_oswiadczenie_z_lakierowaniem_i_stomatologiem.pdf'
              .replaceAll(' ', '_')
