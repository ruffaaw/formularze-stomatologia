...
class StatementWithVarnishScreen extends StatefulWidget {
  const StatementWithVarnishScreen({super.key});
...
class _StatementWithADentistScreenState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Oświadczenie z lakierowaniem')),
  ...
  Future<void> generateAndSavePDF(BuildContext context) async {
    ...
    try {
      ...
      final fileName =
          '${name}_${DateFormat('ddMMyyyy_HHmmss').format(DateTime.now())}_oswiadczenie_z_lakierowaniem.pdf'
              .replaceAll(' ', '_')
